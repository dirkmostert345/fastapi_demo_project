...
from ..db import Base
from ..db.models import contact_detail, user
from ..dtos.requests import users, contact_details
...
contactDetailsRepository = ContactDetailsRespository(contact_detail)